const CACHE_NAME = "sound-steps-v10";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css",
  ...
  "./audio/words/cake.mp3",
  "./audio/words/gate.mp3",
  "./audio/words/name.mp3",
  "./audio/words/game.mp3",
  "./audio/words/tape.mp3",
  "./audio/words/plate.mp3",
  "./audio/words/cave.mp3",
  "./audio/words/bike.mp3",
  "./audio/words/five.mp3",
  "./audio/words/time.mp3",
  "./audio/words/ride.mp3",
  "./audio/words/line.mp3",
  "./audio/words/smile.mp3",
  "./audio/words/hive.mp3",
  "./audio/words/rope.mp3",
  "./audio/words/nose.mp3",
  "./audio/words/hole.mp3",
  "./audio/words/note.mp3",
  "./audio/words/rose.mp3",
  "./audio/words/cube.mp3",
  "./audio/words/mule.mp3",
  "./audio/words/tube.mp3",
  "./audio/words/cute.mp3",
  "./audio/words/bad.mp3",
  "./audio/words/bat.mp3",
